...
class ProcurementBase(models.Model):
    ...
    vendor = models.CharField("Vendor", max_length=255, blank=True, null=True)
    expected_delivery_date = models.DateField("Expected Delivery Date", blank=True, null=True)
    mr_number = models.CharField("MR Number", max_length=255, blank=True, null=True)
    ...
    discipline = models.CharField("Discipline", max_length=255, blank=True, null=True)
    tam_2026 = models.CharField("TAM 2026", max_length=40, blank=True, null=True)
    pmto_code = models.CharField("PMTO CODE", max_length=255, blank=True, null=True)
